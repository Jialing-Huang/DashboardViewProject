...
@Component({
  selector: 'app-d3-scatterchart',
  templateUrl: './d3-scatterchart.component.html',
  styleUrls: ['./d3-scatterchart.component.css']
})
export class D3ScatterchartComponent implements AfterViewInit {
  ...
  private margin = {top: 50, bottom: 20, left: 20, right: 20};
    ...
    createScatterChart() {
      ...
      let xScale = d3.scaleLinear()
                     .domain(xDomain)
                     .range([this.margin.left,450-this.margin.right-this.margin.left]);
